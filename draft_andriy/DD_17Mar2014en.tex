...
\title{Low missing mass, single- and double diffraction dissociation\\ at the LHC}

\author{\firstname{L.}~\surname{Jenkovszky}}
% Здесь разбиение на строки осуществляется автоматически или командой \\
\email{jenk@bitp.kiev.ua}
\affiliation{Bogolyubov Institute for Theoretical Physics (BITP),
Ukrainian National Academy of Sciences 14-b, Metrolohichna str., Kiev, 03680, Ukraine}
\author{\firstname{O.}~\surname{Kuprash}}
\email{oleg.kuprash@desy.de}
\affiliation{Deutsches Elektronen-Synchrotron, Notkestra\ss e 85, 22607 Hamburg, Germany}%
\affiliation{Taras Shevchenko National University, Faculty of Physics,
 Glushkova ave., 2, Kiev, 03022, Ukraine}%
\author{\firstname{R.}~\surname{Orava}}
\email{risto.orava@cern.ch}
%\noaffiliation % если у автора место работы не указывается
\affiliation{Helsinki Institute of Physics, Division of Elementary Particle Physics,
P.O. Box 64 (Gustaf H\"allstr\"ominkatu 2a), FI-00014 University of Helsinki, Finland}
\affiliation{CERN, CH-1211 Geneva 23, Switzerland}

\author{\firstname{A.}~\surname{Salii}}
\email{saliy.andriy@gmail.com}
\affiliation{Bogolyubov Institute for Theoretical Physics (BITP),
Ukrainian National Academy of Sciences 14-b, Metrolohichna str., Kiev, 03680, Ukraine}
...
We thank K. Goulianos, V. Magas and R. Schicker for discussions. L.J. was supported by the National Academy of Ukraine, under the grant \glqq Nuclear matter under extreme condition\grqq and by 
...
K. Goulianos, in the Proceedings of the 13th International Conference on Elastic and Diffractive Scattering (Blois Workshop) \glqq Moving Forward into the LHC Era\grqq, pp. 6 and 121, arXiv:1002.3527 [hep-ph]
  
\bibitem{JMPP}%13
 L.L.~Jenkovszky, E.S.~Martynov and F.~Paccanoni,
  \glqq Proton diffraction dissociation and Unitarity\grqq, 
...
\bibitem{DL}%15
  ...
  \glqq Pomeron physics and QCD\grqq,  Camb. Monogr. Part. Phys. Nucl. Phys. Cosmol. {\bf 19}, 1 (2002).
...
Однократная и двойная дифракционная диссоциация с малыми недостающими массами на Большом Адронном Коллайдере (БАК)}
\end{center}
%
\begin{center}
\bfseries Л.~Енковский, О.~Купраш, Р.~Орава, А.~Салий
\end{center}
%
\begin{center}
\begin{minipage}{\textwidth - 2cm}
\small
Вычислены сечения однократной и двойной дифракционной диссоциации с малыми недостающими массами на Большом Адронном Коллайдере (БАК) в дуальной (Редже) модели с доминирующим обменом реджевским полюсом Померанчука. Модель воспроизводит богатую резонансную структуру в области малых недостающих масс (missing mass) $M_X$. Возбужденные состояния лежат на нуклонной траектории $M_X$, дополненной изолированным резонансом Ропера. Приведены детальные предсказания для зависимости дифференциального и интегрального сечений однократной и двойной дифференциальной дифракционной диссоциации для будущих измерений на Большом Адронном Коллайдере (БАК). 
\end{minipage}
\end{center}
...
\begin{figure}[p] %[!bt]
 %\crentering 
 \hspace{1cm} \includegraphics[width=.9\textwidth]{Fig3_diag.eps}
